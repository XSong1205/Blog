...
export const siteConfig: SiteConfig = {
	title: "XSong's Blog",
	subtitle: "测试中",
	siteURL: "https://blog.rpixel.world/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-10-03", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		asciiFont: {
			...
			fontWeight: "400",
			localFonts: ["JetBrainsMono-Medium.woff2"],
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/XSong1205/",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/68624054",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	title: "公告", // 公告标题
	content: "欢迎来到小宋的博客，虽然我什么也不会写就是了（", // 公告内容
